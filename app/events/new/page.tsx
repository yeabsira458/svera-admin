    ...
    <div className="flex flex-col lg:flex-row min-h-screen" style={{ background: "#f0f4f8" }}>
      ...
      <main className="flex-1 p-4 md:p-8 overflow-auto">
        <div className="flex items-center gap-3 mb-8 fade-in">
          ...
          <h1 className="text-2xl font-extrabold" style={{ color: "#0d2137" }}>New Event</h1>
        </div>
          ...
          >
            ...
            <div>
              <label className="block text-sm font-semibold mb-1.5" style={{ color: "#0d2137" }}>
                Event Title <span style={{ color: "#c0392b" }}>*</span>
              </label>
              <input name="title" type="text" required className="admin-input" placeholder="e.g. Birth Registration Drive – Hawassa" />
            </div>

            {/* Description */}
            <div>
              <label className="block text-sm font-semibold mb-1.5" style={{ color: "#0d2137" }}>Description</label>
              <textarea name="description" className="admin-textarea" rows={4} placeholder="Brief description of the event (optional)..." />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-semibold mb-1.5" style={{ color: "#0d2137" }}>
                  Date & Time <span style={{ color: "#c0392b" }}>*</span>
                </label>
                <input name="event_date" type="datetime-local" required className="admin-input" />
              </div>
              <div>
                <label className="block text-sm font-semibold mb-1.5" style={{ color: "#0d2137" }}>Location</label>
                <input name="location" type="text" className="admin-input" placeholder="Venue or address (optional)" />
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <span className="text-sm font-medium" style={{ color: "#5d6d7e" }}>Click to upload event image</span>
